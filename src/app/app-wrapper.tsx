...
import { createIconsLibrary } from './actions/icons';
...
class AppWrapper extends React.Component<Props> {
  public componentDidMount() {
    const { lastRoute, history, CreateIconsLibrary } = this.props;
...
const mapDispatchtoProps = {
  CreateIconsLibrary: createIconsLibrary,
};
